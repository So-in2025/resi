...
from dependencies import get_db, get_user_or_create, get_dashboard_summary
...
def get_dashboard_summary_endpoint(db: Session = Depends(get_db), user: User = Depends(get_user_or_create)):
